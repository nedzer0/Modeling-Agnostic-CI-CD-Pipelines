...
public class CICDParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CICDGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCacheAccess().getGroup_1_6(), "rule__Cache__Group_1_6__0");
			builder.put(grammarAccess.getCacheAccess().getGroup_1_6_2(), "rule__Cache__Group_1_6_2__0");
			...
			builder.put(grammarAccess.getPipelineAccess().getJobsAssignment_3_0(), "rule__Pipeline__JobsAssignment_3_0");
			builder.put(grammarAccess.getPipelineAccess().getPipeline_environmentAssignment_4_0(), "rule__Pipeline__Pipeline_environmentAssignment_4_0");
			builder.put(grammarAccess.getPipelineAccess().getTriggersAssignment_5_0(), "rule__Pipeline__TriggersAssignment_5_0");
			builder.put(grammarAccess.getPipelineAccess().getAgentsAssignment_6_0(), "rule__Pipeline__AgentsAssignment_6_0");
			builder.put(grammarAccess.getPipelineAccess().getInputsAssignment_7_0(), "rule__Pipeline__InputsAssignment_7_0");
			builder.put(grammarAccess.getPipelineAccess().getOutputAssignment_8_0(), "rule__Pipeline__OutputAssignment_8_0");
			...
			builder.put(grammarAccess.getJobAccess().getStepsAssignment_1_6(), "rule__Job__StepsAssignment_1_6");
			builder.put(grammarAccess.getJobAccess().getIfStepAssignment_1_7(), "rule__Job__IfStepAssignment_1_7");
			builder.put(grammarAccess.getJobAccess().getArtifactsAssignment_1_8(), "rule__Job__ArtifactsAssignment_1_8");
			builder.put(grammarAccess.getJobAccess().getEnvironmentsAssignment_1_9(), "rule__Job__EnvironmentsAssignment_1_9");
			builder.put(grammarAccess.getJobAccess().getJobsAssignment_1_10(), "rule__Job__JobsAssignment_1_10");
			builder.put(grammarAccess.getJobAccess().getMatrixAssignment_1_11(), "rule__Job__MatrixAssignment_1_11");
			builder.put(grammarAccess.getJobAccess().getAgentsAssignment_1_12(), "rule__Job__AgentsAssignment_1_12");
			builder.put(grammarAccess.getJobAccess().getOutputAssignment_1_13(), "rule__Job__OutputAssignment_1_13");
			...
			builder.put(grammarAccess.getCacheAccess().getKeyAssignment_1_5(), "rule__Cache__KeyAssignment_1_5");
			builder.put(grammarAccess.getCacheAccess().getKeysAssignment_1_6_1(), "rule__Cache__KeysAssignment_1_6_1");
			builder.put(grammarAccess.getCacheAccess().getKeysAssignment_1_6_2_1(), "rule__Cache__KeysAssignment_1_6_2_1");
