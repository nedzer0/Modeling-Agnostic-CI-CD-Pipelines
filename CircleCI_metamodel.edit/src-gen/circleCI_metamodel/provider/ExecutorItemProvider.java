...
public class ExecutorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addResourceClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Executor_resourceClass_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Executor_resourceClass_feature",
								"_UI_Executor_type"),
						CircleCI_metamodelPackage.Literals.EXECUTOR__RESOURCE_CLASS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
