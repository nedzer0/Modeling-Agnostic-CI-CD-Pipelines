...
/**
 * This is the item provider adapter for a {@link circleCI_metamodel.When_Unless} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class When_UnlessItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public When_UnlessItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_When_Unless_condition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_When_Unless_condition_feature",
								"_UI_When_Unless_type"),
						CircleCI_metamodelPackage.Literals.WHEN_UNLESS__CONDITION, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CircleCI_metamodelPackage.Literals.WHEN_UNLESS__WHEN_STEP);
			childrenFeatures.add(CircleCI_metamodelPackage.Literals.WHEN_UNLESS__UNLESS_STEP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/When_Unless"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(When_Unless.class)) {
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == CircleCI_metamodelPackage.Literals.WHEN_UNLESS__WHEN_STEP
				|| childFeature == CircleCI_metamodelPackage.Literals.WHEN_UNLESS__UNLESS_STEP;
