...
public class CircleciParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CircleciGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRestoreCacheAccess().getGroup_2(), "rule__RestoreCache__Group_2__0");
			builder.put(grammarAccess.getRestoreCacheAccess().getGroup_2_1(), "rule__RestoreCache__Group_2_1__0");
			builder.put(grammarAccess.getRestoreCacheAccess().getGroup_2_2(), "rule__RestoreCache__Group_2_2__0");
			builder.put(grammarAccess.getRestoreCacheAccess().getGroup_2_3(), "rule__RestoreCache__Group_2_3__0");
			builder.put(grammarAccess.getRestoreCacheAccess().getGroup_2_3_2(), "rule__RestoreCache__Group_2_3_2__0");
			...
			builder.put(grammarAccess.getMachineAccess().getGroup_1_1(), "rule__Machine__Group_1_1__0");
			builder.put(grammarAccess.getMachineAccess().getGroup_1_7(), "rule__Machine__Group_1_7__0");
			...
			builder.put(grammarAccess.getMacOsAccess().getGroup_1_1(), "rule__MacOs__Group_1_1__0");
			builder.put(grammarAccess.getMacOsAccess().getGroup_1_2(), "rule__MacOs__Group_1_2__0");
			...
			builder.put(grammarAccess.getDockerAccess().getGroup_1_1(), "rule__Docker__Group_1_1__0");
			...
			builder.put(grammarAccess.getPipelineAccess().getSetupAssignment_1_1(), "rule__Pipeline__SetupAssignment_1_1");
			builder.put(grammarAccess.getPipelineAccess().getVersionAssignment_1_3(), "rule__Pipeline__VersionAssignment_1_3");
			builder.put(grammarAccess.getPipelineAccess().getOrbsAssignment_2_0(), "rule__Pipeline__OrbsAssignment_2_0");
			builder.put(grammarAccess.getPipelineAccess().getCommandsAssignment_3_0(), "rule__Pipeline__CommandsAssignment_3_0");
			builder.put(grammarAccess.getPipelineAccess().getExecutorsAssignment_4_0(), "rule__Pipeline__ExecutorsAssignment_4_0");
			builder.put(grammarAccess.getPipelineAccess().getJobsAssignment_5_0(), "rule__Pipeline__JobsAssignment_5_0");
			builder.put(grammarAccess.getPipelineAccess().getWorkflowsAssignment_6_0(), "rule__Pipeline__WorkflowsAssignment_6_0");
			...
			builder.put(grammarAccess.getJobAccess().getReuseCommandAssignment_1_4_1(), "rule__Job__ReuseCommandAssignment_1_4_1");
			...
			builder.put(grammarAccess.getJobAccess().getParametersAssignment_1_7(), "rule__Job__ParametersAssignment_1_7");
			builder.put(grammarAccess.getJobAccess().getStepsAssignment_1_8(), "rule__Job__StepsAssignment_1_8");
			...
			builder.put(grammarAccess.getRestoreCacheAccess().getNameAssignment_2_1_1(), "rule__RestoreCache__NameAssignment_2_1_1");
			builder.put(grammarAccess.getRestoreCacheAccess().getKeyAssignment_2_2_1(), "rule__RestoreCache__KeyAssignment_2_2_1");
			builder.put(grammarAccess.getRestoreCacheAccess().getKeysAssignment_2_3_1(), "rule__RestoreCache__KeysAssignment_2_3_1");
			builder.put(grammarAccess.getRestoreCacheAccess().getKeysAssignment_2_3_2_1(), "rule__RestoreCache__KeysAssignment_2_3_2_1");
			...
			builder.put(grammarAccess.getMachineAccess().getNameAssignment_1_1_1(), "rule__Machine__NameAssignment_1_1_1");
			builder.put(grammarAccess.getMachineAccess().getImageAssignment_1_3(), "rule__Machine__ImageAssignment_1_3");
			builder.put(grammarAccess.getMachineAccess().getDocker_layer_cachingAssignment_1_4(), "rule__Machine__Docker_layer_cachingAssignment_1_4");
			builder.put(grammarAccess.getMachineAccess().getResourceClassAssignment_1_6(), "rule__Machine__ResourceClassAssignment_1_6");
			builder.put(grammarAccess.getMachineAccess().getShellAssignment_1_7_1(), "rule__Machine__ShellAssignment_1_7_1");
			builder.put(grammarAccess.getMachineAccess().getWorking_directoryAssignment_1_8_1(), "rule__Machine__Working_directoryAssignment_1_8_1");
			builder.put(grammarAccess.getMachineAccess().getEnvironmentsAssignment_1_9(), "rule__Machine__EnvironmentsAssignment_1_9");
			builder.put(grammarAccess.getMacOsAccess().getNameAssignment_1_1_1(), "rule__MacOs__NameAssignment_1_1_1");
			builder.put(grammarAccess.getMacOsAccess().getXcodeAssignment_1_2_1(), "rule__MacOs__XcodeAssignment_1_2_1");
			builder.put(grammarAccess.getMacOsAccess().getResourceClassAssignment_1_3_1(), "rule__MacOs__ResourceClassAssignment_1_3_1");
			builder.put(grammarAccess.getMacOsAccess().getShellAssignment_1_4_1(), "rule__MacOs__ShellAssignment_1_4_1");
			builder.put(grammarAccess.getMacOsAccess().getWorking_directoryAssignment_1_5_1(), "rule__MacOs__Working_directoryAssignment_1_5_1");
			builder.put(grammarAccess.getMacOsAccess().getEnvironmentsAssignment_1_6(), "rule__MacOs__EnvironmentsAssignment_1_6");
			builder.put(grammarAccess.getDockerAccess().getNameAssignment_1_1_1(), "rule__Docker__NameAssignment_1_1_1");
			builder.put(grammarAccess.getDockerAccess().getImageAssignment_1_3(), "rule__Docker__ImageAssignment_1_3");
			builder.put(grammarAccess.getDockerAccess().getResourceClassAssignment_1_5(), "rule__Docker__ResourceClassAssignment_1_5");
			builder.put(grammarAccess.getDockerAccess().getShellAssignment_1_6_1(), "rule__Docker__ShellAssignment_1_6_1");
			builder.put(grammarAccess.getDockerAccess().getWorking_directoryAssignment_1_7_1(), "rule__Docker__Working_directoryAssignment_1_7_1");
			builder.put(grammarAccess.getDockerAccess().getEntrypointAssignment_1_8_1(), "rule__Docker__EntrypointAssignment_1_8_1");
			builder.put(grammarAccess.getDockerAccess().getEntrypointAssignment_1_8_2_1(), "rule__Docker__EntrypointAssignment_1_8_2_1");
			builder.put(grammarAccess.getDockerAccess().getCommandAssignment_1_9_1(), "rule__Docker__CommandAssignment_1_9_1");
			builder.put(grammarAccess.getDockerAccess().getCommandAssignment_1_9_2_1(), "rule__Docker__CommandAssignment_1_9_2_1");
			builder.put(grammarAccess.getDockerAccess().getUserAssignment_1_10_1(), "rule__Docker__UserAssignment_1_10_1");
			builder.put(grammarAccess.getDockerAccess().getEnvironmentsAssignment_1_11(), "rule__Docker__EnvironmentsAssignment_1_11");
			builder.put(grammarAccess.getDockerAccess().getDocker_authAssignment_1_12(), "rule__Docker__Docker_authAssignment_1_12");
			builder.put(grammarAccess.getDockerAccess().getDocker_aws_authAssignment_1_13(), "rule__Docker__Docker_aws_authAssignment_1_13");
