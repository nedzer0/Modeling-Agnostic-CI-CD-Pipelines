...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/GitHubActions2/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(DevOpsPackage.class)) {
	        // The normal package registration if your metamodel is in a plugin.
	        resourceSet.getPackageRegistry().put(DevOpsPackage.eNS_URI, DevOpsPackage.eINSTANCE);
	    }
    }
