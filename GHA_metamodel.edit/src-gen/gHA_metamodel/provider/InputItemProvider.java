...
/**
 * This is the item provider adapter for a {@link gHA_metamodel.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						GHA_metamodelPackage.Literals.INPUT__TYPE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Input_isRequired_feature",
								"_UI_Input_type"),
						GHA_metamodelPackage.Literals.INPUT__IS_REQUIRED, true, false, false,
	...
	protected void addOptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						GHA_metamodelPackage.Literals.INPUT__OPTIONS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						GHA_metamodelPackage.Literals.INPUT__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Input_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Input_description_feature",
								"_UI_Input_type"),
						GHA_metamodelPackage.Literals.INPUT__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Input_default_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Input_default_feature", "_UI_Input_type"),
						GHA_metamodelPackage.Literals.INPUT__DEFAULT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case GHA_metamodelPackage.INPUT__TYPE:
		case GHA_metamodelPackage.INPUT__IS_REQUIRED:
		case GHA_metamodelPackage.INPUT__OPTIONS:
		case GHA_metamodelPackage.INPUT__NAME:
		case GHA_metamodelPackage.INPUT__DESCRIPTION:
		case GHA_metamodelPackage.INPUT__DEFAULT:
