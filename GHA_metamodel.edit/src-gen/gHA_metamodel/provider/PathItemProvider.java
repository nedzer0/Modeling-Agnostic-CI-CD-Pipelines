...
/**
 * This is the item provider adapter for a {@link gHA_metamodel.Path} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Path_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Path_name_feature", "_UI_Path_type"),
						GHA_metamodelPackage.Literals.PATH__NAME, true, false, false,
	...
	protected void addIgnorePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Path_ignore_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Path_ignore_feature", "_UI_Path_type"),
						GHA_metamodelPackage.Literals.PATH__IGNORE, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case GHA_metamodelPackage.PATH__NAME:
		case GHA_metamodelPackage.PATH__IGNORE:
