...
/**
 * This is the item provider adapter for a {@link cICD_metamodel.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_name_feature",
								"_UI_Artifact_type"),
						CICD_metamodelPackage.Literals.ARTIFACT__NAME, true, false, false,
	...
	protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Artifact_message_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_message_feature",
								"_UI_Artifact_type"),
						CICD_metamodelPackage.Literals.ARTIFACT__MESSAGE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Artifact_path_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_path_feature",
								"_UI_Artifact_type"),
						CICD_metamodelPackage.Literals.ARTIFACT__PATH, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_type_feature",
								"_UI_Artifact_type"),
						CICD_metamodelPackage.Literals.ARTIFACT__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case CICD_metamodelPackage.ARTIFACT__NAME:
		case CICD_metamodelPackage.ARTIFACT__MESSAGE:
		case CICD_metamodelPackage.ARTIFACT__PATH:
		case CICD_metamodelPackage.ARTIFACT__TYPE:
