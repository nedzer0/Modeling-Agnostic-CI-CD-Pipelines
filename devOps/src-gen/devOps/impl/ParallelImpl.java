 ...
 * </p>
 * <ul>
 *   <li>{@link devOps.impl.ParallelImpl#getJob <em>Job</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParallelImpl extends MinimalEObjectImpl.Container implements Parallel {
	...
	protected EClass eStaticClass() {
		return DevOpsPackage.Literals.PARALLEL;
	}
	...
	public EList<Job> getJob() {
		if (job == null) {
			job = new EObjectContainmentEList<Job>(Job.class, this, DevOpsPackage.PARALLEL__JOB);
		}
		return job;
	}
