 ...
 * </p>
 * <ul>
 *   <li>{@link devOps.impl.ParametersImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametersImpl extends MinimalEObjectImpl.Container implements Parameters {
	...
	protected EClass eStaticClass() {
		return DevOpsPackage.Literals.PARAMETERS;
	}
	...
	public void setParameter(String newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DevOpsPackage.PARAMETERS__PARAMETER, oldParameter,
					parameter));
	}
