...
public interface CircleCI_metamodelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EXECUTOR__WORKING_DIRECTORY = 2;
	 ...
	 * @ordered
	 */
	int MACHINE__RESOURCE_CLASS = EXECUTOR_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int MACHINE_FEATURE_COUNT = EXECUTOR_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int MAC_OS__RESOURCE_CLASS = EXECUTOR_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MAC_OS_FEATURE_COUNT = EXECUTOR_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int DOCKER__RESOURCE_CLASS = EXECUTOR_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int DOCKER_FEATURE_COUNT = EXECUTOR_FEATURE_COUNT + 7;
	...
	/**
	 * The meta object id for the '{@link circleCI_metamodel.DOCKER_RESOURCE_TYPE <em>DOCKER RESOURCE TYPE</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see circleCI_metamodel.DOCKER_RESOURCE_TYPE
	 * @see circleCI_metamodel.impl.CircleCI_metamodelPackageImpl#getDOCKER_RESOURCE_TYPE()
	 * @generated
	 */
	int DOCKER_RESOURCE_TYPE = 35;

	/**
	 * The meta object id for the '{@link circleCI_metamodel.MACOS_RESOURCE_TYPE <em>MACOS RESOURCE TYPE</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see circleCI_metamodel.MACOS_RESOURCE_TYPE
	 * @see circleCI_metamodel.impl.CircleCI_metamodelPackageImpl#getMACOS_RESOURCE_TYPE()
	 * @generated
	 */
	int MACOS_RESOURCE_TYPE = 36;

	/**
	 * The meta object id for the '{@link circleCI_metamodel.MACHINE_RESOURCE_TYPE <em>MACHINE RESOURCE TYPE</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see circleCI_metamodel.MACHINE_RESOURCE_TYPE
	 * @see circleCI_metamodel.impl.CircleCI_metamodelPackageImpl#getMACHINE_RESOURCE_TYPE()
	 * @generated
	 */
	int MACHINE_RESOURCE_TYPE = 37;
	...
	/**
	 * Returns the meta object for the attribute '{@link circleCI_metamodel.Machine#getResourceClass <em>Resource Class</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Resource Class</em>'.
	 * @see circleCI_metamodel.Machine#getResourceClass()
	 * @see #getMachine()
	 * @generated
	 */
	EAttribute getMachine_ResourceClass();
	...
	/**
	 * Returns the meta object for the attribute '{@link circleCI_metamodel.MacOs#getResourceClass <em>Resource Class</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Resource Class</em>'.
	 * @see circleCI_metamodel.MacOs#getResourceClass()
	 * @see #getMacOs()
	 * @generated
	 */
	EAttribute getMacOs_ResourceClass();
	...
	/**
	 * Returns the meta object for the attribute '{@link circleCI_metamodel.Docker#getResourceClass <em>Resource Class</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Resource Class</em>'.
	 * @see circleCI_metamodel.Docker#getResourceClass()
	 * @see #getDocker()
	 * @generated
	 */
	EAttribute getDocker_ResourceClass();
	...
	/**
	 * Returns the meta object for enum '{@link circleCI_metamodel.DOCKER_RESOURCE_TYPE <em>DOCKER RESOURCE TYPE</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for enum '<em>DOCKER RESOURCE TYPE</em>'.
	 * @see circleCI_metamodel.DOCKER_RESOURCE_TYPE
	 * @generated
	 */
	EEnum getDOCKER_RESOURCE_TYPE();

	/**
	 * Returns the meta object for enum '{@link circleCI_metamodel.MACOS_RESOURCE_TYPE <em>MACOS RESOURCE TYPE</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for enum '<em>MACOS RESOURCE TYPE</em>'.
	 * @see circleCI_metamodel.MACOS_RESOURCE_TYPE
	 * @generated
	 */
	EEnum getMACOS_RESOURCE_TYPE();

	/**
	 * Returns the meta object for enum '{@link circleCI_metamodel.MACHINE_RESOURCE_TYPE <em>MACHINE RESOURCE TYPE</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for enum '<em>MACHINE RESOURCE TYPE</em>'.
	 * @see circleCI_metamodel.MACHINE_RESOURCE_TYPE
	 * @generated
	 */
	EEnum getMACHINE_RESOURCE_TYPE();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute MACHINE__RESOURCE_CLASS = eINSTANCE.getMachine_ResourceClass();
		 ...
		 * @generated
		 */
		EAttribute MAC_OS__RESOURCE_CLASS = eINSTANCE.getMacOs_ResourceClass();
		 ...
		 * @generated
		 */
		EAttribute DOCKER__RESOURCE_CLASS = eINSTANCE.getDocker_ResourceClass();
		...
		/**
		 * The meta object literal for the '{@link circleCI_metamodel.DOCKER_RESOURCE_TYPE <em>DOCKER RESOURCE TYPE</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see circleCI_metamodel.DOCKER_RESOURCE_TYPE
		 * @see circleCI_metamodel.impl.CircleCI_metamodelPackageImpl#getDOCKER_RESOURCE_TYPE()
		 * @generated
		 */
		EEnum DOCKER_RESOURCE_TYPE = eINSTANCE.getDOCKER_RESOURCE_TYPE();

		/**
		 * The meta object literal for the '{@link circleCI_metamodel.MACOS_RESOURCE_TYPE <em>MACOS RESOURCE TYPE</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see circleCI_metamodel.MACOS_RESOURCE_TYPE
		 * @see circleCI_metamodel.impl.CircleCI_metamodelPackageImpl#getMACOS_RESOURCE_TYPE()
		 * @generated
		 */
		EEnum MACOS_RESOURCE_TYPE = eINSTANCE.getMACOS_RESOURCE_TYPE();

		/**
		 * The meta object literal for the '{@link circleCI_metamodel.MACHINE_RESOURCE_TYPE <em>MACHINE RESOURCE TYPE</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see circleCI_metamodel.MACHINE_RESOURCE_TYPE
		 * @see circleCI_metamodel.impl.CircleCI_metamodelPackageImpl#getMACHINE_RESOURCE_TYPE()
		 * @generated
		 */
		EEnum MACHINE_RESOURCE_TYPE = eINSTANCE.getMACHINE_RESOURCE_TYPE();
