 ...
 *   <li>{@link circleCI_metamodel.impl.DockerImpl#getResourceClass <em>Resource Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DockerImpl extends ExecutorImpl implements Docker {
	 ...
	 * @ordered
	 */
	protected static final DOCKER_RESOURCE_TYPE RESOURCE_CLASS_EDEFAULT = DOCKER_RESOURCE_TYPE.SMALL;
	 ...
	 * @ordered
	 */
	protected DOCKER_RESOURCE_TYPE resourceClass = RESOURCE_CLASS_EDEFAULT;
	 ...
	 */
	@Override
	public DOCKER_RESOURCE_TYPE getResourceClass() {
	 ...
	 */
	@Override
	public void setResourceClass(DOCKER_RESOURCE_TYPE newResourceClass) {
		DOCKER_RESOURCE_TYPE oldResourceClass = resourceClass;
		resourceClass = newResourceClass == null ? RESOURCE_CLASS_EDEFAULT : newResourceClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CircleCI_metamodelPackage.DOCKER__RESOURCE_CLASS,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case CircleCI_metamodelPackage.DOCKER__USER:
			...
			return;
		case CircleCI_metamodelPackage.DOCKER__RESOURCE_CLASS:
			setResourceClass((DOCKER_RESOURCE_TYPE) newValue);
			return;
		}
