 ...
 * </p>
 * <ul>
 *   <li>{@link jenkins_metamodel.impl.TagImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link jenkins_metamodel.impl.TagImpl#getComparator <em>Comparator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TagImpl extends WhenImpl implements Tag {
	/**
	...
	protected EClass eStaticClass() {
		return Jenkins_metamodelPackage.Literals.TAG;
	}
	...
	public void setPattern(String newPattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jenkins_metamodelPackage.TAG__PATTERN, oldPattern,
					pattern));
	}
	...
	public void setComparator(COMPARATOR_TYPE newComparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jenkins_metamodelPackage.TAG__COMPARATOR,
