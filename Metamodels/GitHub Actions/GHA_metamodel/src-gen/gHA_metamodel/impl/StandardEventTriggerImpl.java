 ...
 * </p>
 * <ul>
 *   <li>{@link gHA_metamodel.impl.StandardEventTriggerImpl#getEvent <em>Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandardEventTriggerImpl extends EventTriggerImpl implements StandardEventTrigger {
	/**
	...
	protected EClass eStaticClass() {
		return GHA_metamodelPackage.Literals.STANDARD_EVENT_TRIGGER;
	}
	...
	public void setEvent(EVENTS newEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GHA_metamodelPackage.STANDARD_EVENT_TRIGGER__EVENT,
					oldEvent, event));
	}
