 ...
 * </p>
 * <ul>
 *   <li>{@link gHA_metamodel.impl.PathImpl#getName <em>Name</em>}</li>
 *   <li>{@link gHA_metamodel.impl.PathImpl#isIgnore <em>Ignore</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathImpl extends MinimalEObjectImpl.Container implements Path {
	...
	protected EClass eStaticClass() {
		return GHA_metamodelPackage.Literals.PATH;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GHA_metamodelPackage.PATH__NAME, oldName, name));
	}
	...
	public void setIgnore(boolean newIgnore) {
		...
		ignore = newIgnore;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GHA_metamodelPackage.PATH__IGNORE, oldIgnore,
					ignore));
	}
