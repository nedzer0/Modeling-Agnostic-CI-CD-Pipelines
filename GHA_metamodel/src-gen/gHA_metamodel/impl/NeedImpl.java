 ...
 * </p>
 * <ul>
 *   <li>{@link gHA_metamodel.impl.NeedImpl#getJobs <em>Jobs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NeedImpl extends MinimalEObjectImpl.Container implements Need {
	...
	protected EClass eStaticClass() {
		return GHA_metamodelPackage.Literals.NEED;
	}
	...
	public EList<String> getJobs() {
		if (jobs == null) {
			jobs = new EDataTypeUniqueEList<String>(String.class, this, GHA_metamodelPackage.NEED__JOBS);
		}
		return jobs;
	}
