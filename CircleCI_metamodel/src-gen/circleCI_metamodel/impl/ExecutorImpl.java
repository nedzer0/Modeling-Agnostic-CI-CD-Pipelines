 ...
 *   <li>{@link circleCI_metamodel.impl.ExecutorImpl#getResourceClass <em>Resource Class</em>}</li>
...
public abstract class ExecutorImpl extends MinimalEObjectImpl.Container implements Executor {
	 ...
	 * @ordered
	 */
	protected static final String RESOURCE_CLASS_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected String resourceClass = RESOURCE_CLASS_EDEFAULT;
	 ...
	 */
	@Override
	public void setResourceClass(String newResourceClass) {
		String oldResourceClass = resourceClass;
		resourceClass = newResourceClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CircleCI_metamodelPackage.EXECUTOR__RESOURCE_CLASS,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CircleCI_metamodelPackage.EXECUTOR__NAME:
			return getName();
		case CircleCI_metamodelPackage.EXECUTOR__RESOURCE_CLASS:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case CircleCI_metamodelPackage.EXECUTOR__NAME:
			...
			return;
		case CircleCI_metamodelPackage.EXECUTOR__RESOURCE_CLASS:
			setResourceClass((String) newValue);
			return;
		case CircleCI_metamodelPackage.EXECUTOR__SHELL:
	...
	public boolean eIsSet(int featureID) {
		...
		case CircleCI_metamodelPackage.EXECUTOR__RESOURCE_CLASS:
			return RESOURCE_CLASS_EDEFAULT == null ? resourceClass != null
					: !RESOURCE_CLASS_EDEFAULT.equals(resourceClass);
		case CircleCI_metamodelPackage.EXECUTOR__SHELL:
