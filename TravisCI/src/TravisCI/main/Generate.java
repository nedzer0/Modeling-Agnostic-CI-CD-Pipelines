...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/TravisCI/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(TravisCI_metamodelPackage.class)) {
	        // The normal package registration if your metamodel is in a plugin.
	        resourceSet.getPackageRegistry().put(TravisCI_metamodelPackage.eNS_URI, TravisCI_metamodelPackage.eINSTANCE);
	    }
    }
