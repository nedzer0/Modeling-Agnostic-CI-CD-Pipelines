 ...
 * </p>
 * <ul>
 *   <li>{@link jenkins_metamodel.impl.AllOfImpl#getWhen <em>When</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllOfImpl extends WhenImpl implements AllOf {
	/**
	...
	protected EClass eStaticClass() {
		return Jenkins_metamodelPackage.Literals.ALL_OF;
	}
	...
	public EList<When> getWhen() {
		if (when == null) {
			when = new EObjectContainmentEList<When>(When.class, this, Jenkins_metamodelPackage.ALL_OF__WHEN);
		}
		return when;
	}
