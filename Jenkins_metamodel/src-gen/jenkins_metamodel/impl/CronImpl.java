 ...
 * </p>
 * <ul>
 *   <li>{@link jenkins_metamodel.impl.CronImpl#getTimer <em>Timer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CronImpl extends TriggerImpl implements Cron {
	...
	protected EClass eStaticClass() {
		return Jenkins_metamodelPackage.Literals.CRON;
	}
	...
	public void setTimer(String newTimer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jenkins_metamodelPackage.CRON__TIMER, oldTimer,
					timer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Jenkins_metamodelPackage.CRON__TIMER:
			return getTimer();
		}
