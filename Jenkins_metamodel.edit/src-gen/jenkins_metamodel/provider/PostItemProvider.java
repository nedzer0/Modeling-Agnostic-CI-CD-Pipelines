...
/**
 * This is the item provider adapter for a {@link jenkins_metamodel.Post} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PostItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Post_condition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Post_condition_feature", "_UI_Post_type"),
						Jenkins_metamodelPackage.Literals.POST__CONDITION, true, false, false,
	...
	public String getText(Object object) {
		POST_TYPE labelValue = ((Post) object).getCondition();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_Post_type")
