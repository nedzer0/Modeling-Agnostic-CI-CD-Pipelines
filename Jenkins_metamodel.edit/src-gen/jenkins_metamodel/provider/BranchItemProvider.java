...
/**
 * This is the item provider adapter for a {@link jenkins_metamodel.Branch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BranchItemProvider extends WhenItemProvider {
	/**
	...
	protected void addPatternPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Branch_pattern_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Branch_pattern_feature",
								"_UI_Branch_type"),
						Jenkins_metamodelPackage.Literals.BRANCH__PATTERN, true, false, false,
	...
	protected void addComparatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Branch_comparator_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Branch_comparator_feature",
								"_UI_Branch_type"),
						Jenkins_metamodelPackage.Literals.BRANCH__COMPARATOR, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Branch) object).getPattern();
