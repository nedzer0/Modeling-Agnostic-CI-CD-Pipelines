 ...
 * <!-- end-user-doc -->
 * @see travisCI_metamodel.TravisCI_metamodelPackage#getJOB_TYPE()
 * @model
 * @generated
 */
public enum JOB_TYPE implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final JOB_TYPE[] VALUES_ARRAY = new JOB_TYPE[] { INCLUDE, EXCLUDE, };
	 ...
	 * @generated
	 */
	public static final List<JOB_TYPE> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static JOB_TYPE get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			JOB_TYPE result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static JOB_TYPE getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			JOB_TYPE result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static JOB_TYPE get(int value) {
		switch (value) {
		case INCLUDE_VALUE:
			return INCLUDE;
		case EXCLUDE_VALUE:
	 ...
	 * @generated
	 */
	private JOB_TYPE(int value, String name, String literal) {
		this.value = value;
		this.name = name;
