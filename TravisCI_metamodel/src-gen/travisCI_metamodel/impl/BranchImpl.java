...
import travisCI_metamodel.BRANCH_TYPE;
 ...
 * </p>
 * <ul>
 *   <li>{@link travisCI_metamodel.impl.BranchImpl#getName <em>Name</em>}</li>
 *   <li>{@link travisCI_metamodel.impl.BranchImpl#getBranch_type <em>Branch type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BranchImpl extends MinimalEObjectImpl.Container implements Branch {
	 ...
	 * @ordered
	 */
	protected static final BRANCH_TYPE BRANCH_TYPE_EDEFAULT = BRANCH_TYPE.SAFELIST;
	...
	protected EClass eStaticClass() {
		return TravisCI_metamodelPackage.Literals.BRANCH;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TravisCI_metamodelPackage.BRANCH__NAME, oldName,
					name));
	}
	...
	public void setBranch_type(BRANCH_TYPE newBranch_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TravisCI_metamodelPackage.BRANCH__BRANCH_TYPE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TravisCI_metamodelPackage.BRANCH__NAME:
			return getName();
		case TravisCI_metamodelPackage.BRANCH__BRANCH_TYPE:
