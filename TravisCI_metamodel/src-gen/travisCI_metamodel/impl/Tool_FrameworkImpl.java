 ...
 * </p>
 * <ul>
 *   <li>{@link travisCI_metamodel.impl.Tool_FrameworkImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tool_FrameworkImpl extends MinimalEObjectImpl.Container implements Tool_Framework {
	...
	protected EClass eStaticClass() {
		return TravisCI_metamodelPackage.Literals.TOOL_FRAMEWORK;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TravisCI_metamodelPackage.TOOL_FRAMEWORK__NAME,
					oldName, name));
	}
