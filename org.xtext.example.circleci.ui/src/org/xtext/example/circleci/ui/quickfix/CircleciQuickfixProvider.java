...
public class CircleciQuickfixProvider extends DefaultQuickfixProvider {
	...
	@Fix(CircleciValidator.INVALID_DOCKER_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidDockerResourceClass(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Docker Resource Class to 'small'", "Set a valid resource class for Docker.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"small\"");
	        }
	    });
	}
	
	@Fix(CircleciValidator.INVALID_DOCKER_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidDockerResourceClass2(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Docker Resource Class to 'medium'", "Set a valid resource class for Docker.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"medium\"");
	        }
	    });
	}
	
	@Fix(CircleciValidator.INVALID_DOCKER_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidDockerResourceClass3(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Docker Resource Class to 'medium+'", "Set a valid resource class for Docker.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"medium+\"");
	...
	@Fix(CircleciValidator.INVALID_DOCKER_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidDockerResourceClass4(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Docker Resource Class to 'large'", "Set a valid resource class for Docker.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"large\"");
	        }
	    });
	}
	
	@Fix(CircleciValidator.INVALID_DOCKER_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidDockerResourceClass5(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Docker Resource Class to 'xlarge'", "Set a valid resource class for Docker.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"xlarge\"");
	        }
	    });
	}
	
	@Fix(CircleciValidator.INVALID_DOCKER_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidDockerResourceClass6(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Docker Resource Class to '2xlarge'", "Set a valid resource class for Docker.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"2xlarge\"");
	        }
	    });
	}
	
	@Fix(CircleciValidator.INVALID_DOCKER_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidDockerResourceClass7(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Docker Resource Class to '2xlarge+'", "Set a valid resource class for Docker.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"2xlarge+\"");
	...
	@Fix(CircleciValidator.INVALID_MACHINE_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidMachineResourceClass(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Machine Resource Class to 'medium'", "Set a valid resource class for Machine.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"medium\"");
	        }
	...
	@Fix(CircleciValidator.INVALID_MACHINE_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidMachineResourceClass2(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Machine Resource Class to 'large'", "Set a valid resource class for Machine.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"large\"");
	        }
	...
	@Fix(CircleciValidator.INVALID_MACHINE_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidMachineResourceClass3(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Machine Resource Class to 'xlarge'", "Set a valid resource class for Machine.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"xlarge\"");
	        }
	...
	@Fix(CircleciValidator.INVALID_MACHINE_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidMachineResourceClass4(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Machine Resource Class to '2xlarge'", "Set a valid resource class for Machine.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"2xlarge\"");
	        }
	...
	@Fix(CircleciValidator.INVALID_MACHINE_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidMachineResourceClass5(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set Machine Resource Class to '2xlarge+'", "Set a valid resource class for Machine.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"2xlarge+\"");
	...
	@Fix(CircleciValidator.INVALID_MACOS_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidMacOsResourceClass(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set MacOS Resource Class to 'macos.x86.medium.gen2*'", "Set a valid resource class for MacOS.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"macos.x86.medium.gen2*\"");
	        }
	    });
	}
	
	@Fix(CircleciValidator.INVALID_MACOS_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidMacOsResourceClass2(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set MacOS Resource Class to 'macos.m1.medium.gen1'", "Set a valid resource class for MacOS.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"macos.m1.medium.gen1\"");
	        }
	    });
	}
	
	@Fix(CircleciValidator.INVALID_MACOS_RESOURCE_CLASS_ERRORCODE)
	public void fixInvalidMacOsResourceClass3(Issue issue, IssueResolutionAcceptor acceptor) {
	    acceptor.accept(issue, "Set MacOS Resource Class to 'macos.m1.large.gen1'", "Set a valid resource class for MacOS.", null, new IModification() {
	        public void apply(IModificationContext context) throws BadLocationException {
	        	IXtextDocument xtextDocument = context.getXtextDocument();
	        	xtextDocument.replace(issue.getOffset(), issue.getLength(), "\"macos.m1.large.gen1\"");
	        }
	    });
	}
