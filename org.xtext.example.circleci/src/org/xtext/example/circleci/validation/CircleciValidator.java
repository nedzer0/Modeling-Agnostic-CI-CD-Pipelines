...
public class CircleciValidator extends AbstractCircleciValidator {
	...
	public static final String INVALID_DOCKER_RESOURCE_CLASS = "Docker resource class only supports the following options: 'small', 'medium', 'medium+', 'large', 'xlarge', '2xlarge', '2xlarge+'";
	public static final String INVALID_MACHINE_RESOURCE_CLASS = "Machine resource class only supports the following options: 'medium', 'large', 'xlarge', '2xlarge', '2xlarge+'";
	public static final String INVALID_MACOS_RESOURCE_CLASS = "MacOs resource class only supports the following options: 'macos.x86.medium.gen2*', 'macos.m1.medium.gen1', 'macos.m1.large.gen1'";
	...
	@Check
	public void checkValidDockerResourceClass(Docker docker) {
	    List<String> validResourceClasses = List.of("small", "medium", "medium+", "large", "xlarge", "2xlarge", "2xlarge+");
	    if (!validResourceClasses.contains(docker.getResourceClass())) {
	        EStructuralFeature resourceClassFeature = docker.eClass().getEStructuralFeature("resourceClass");
	        error(INVALID_DOCKER_RESOURCE_CLASS, docker, resourceClassFeature, INVALID_DOCKER_RESOURCE_CLASS_ERRORCODE);
	    }
	}

	@Check
	public void checkValidMachineResourceClass(Machine machine) {
	    List<String> validResourceClasses = List.of("medium", "large", "xlarge", "2xlarge", "2xlarge+");
	    if (!validResourceClasses.contains(machine.getResourceClass())) {
	        EStructuralFeature resourceClassFeature = machine.eClass().getEStructuralFeature("resourceClass");
	        error(INVALID_MACHINE_RESOURCE_CLASS, machine, resourceClassFeature, INVALID_MACHINE_RESOURCE_CLASS_ERRORCODE);
	    }
	}

	@Check
	public void checkValidMacOsResourceClass(MacOs macOs) {
	    List<String> validResourceClasses = List.of("macos.x86.medium.gen2*", "macos.m1.medium.gen1", "macos.m1.large.gen1");
	    if (!validResourceClasses.contains(macOs.getResourceClass())) {
	        EStructuralFeature resourceClassFeature = macOs.eClass().getEStructuralFeature("resourceClass");
	        error(INVALID_MACOS_RESOURCE_CLASS, macOs, resourceClassFeature, INVALID_MACOS_RESOURCE_CLASS_ERRORCODE);
	    }
	}
