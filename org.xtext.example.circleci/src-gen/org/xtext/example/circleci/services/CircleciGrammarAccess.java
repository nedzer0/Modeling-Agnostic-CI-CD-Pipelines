...
public class CircleciGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class JobElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cReuseExecutorKeyword_1_3 = (Keyword)cGroup_1.eContents().get(3);
		private final Assignment cReuseExecutorAssignment_1_4 = (Assignment)cGroup_1.eContents().get(4);
		private final RuleCall cReuseExecutorEStringParserRuleCall_1_4_0 = (RuleCall)cReuseExecutorAssignment_1_4.eContents().get(0);
		...
		private final Assignment cExecutorsAssignment_1_8 = (Assignment)cGroup_1.eContents().get(8);
		private final RuleCall cExecutorsExecutorParserRuleCall_1_8_0 = (RuleCall)cExecutorsAssignment_1_8.eContents().get(0);
		private final RuleCall cENDTerminalRuleCall_1_9 = (RuleCall)cGroup_1.eContents().get(9);
		...
		//'reuseExecutor'
		public Keyword getReuseExecutorKeyword_1_3() { return cReuseExecutorKeyword_1_3; }
		
		//reuseExecutor=EString
		public Assignment getReuseExecutorAssignment_1_4() { return cReuseExecutorAssignment_1_4; }
		
		//EString
		public RuleCall getReuseExecutorEStringParserRuleCall_1_4_0() { return cReuseExecutorEStringParserRuleCall_1_4_0; }
		...
		//(executors+=Executor)*
		public Assignment getExecutorsAssignment_1_8() { return cExecutorsAssignment_1_8; }
		
		//Executor
		public RuleCall getExecutorsExecutorParserRuleCall_1_8_0() { return cExecutorsExecutorParserRuleCall_1_8_0; }
	...
	public class MachineElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cResourceClassEStringParserRuleCall_1_7_0 = (RuleCall)cResourceClassAssignment_1_7.eContents().get(0);
		...
		//        'image' image=EString
		//        (docker_layer_caching?='docker_layer_caching')?
		//        'resourceClass' resourceClass=EString
		//        ('shell' shell=EString )?
		//        ('working_directory' working_directory=EString )?
		//        (environments+=Environment)*
		//    END);
		...
		//EString
		public RuleCall getResourceClassEStringParserRuleCall_1_7_0() { return cResourceClassEStringParserRuleCall_1_7_0; }
	...
	public class MacOsElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cResourceClassEStringParserRuleCall_1_4_1_0 = (RuleCall)cResourceClassAssignment_1_4_1.eContents().get(0);
		private final Group cGroup_1_5 = (Group)cGroup_1.eContents().get(5);
		...
		//EString
		public RuleCall getResourceClassEStringParserRuleCall_1_4_1_0() { return cResourceClassEStringParserRuleCall_1_4_1_0; }
	...
	public class MacOsResourceClassOptionsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.circleci.Circleci.MacOsResourceClassOptions");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Keyword cMacosX86MediumGen2Keyword_0 = (Keyword)cAlternatives.eContents().get(0);
		private final Keyword cMacosM1MediumGen1Keyword_1 = (Keyword)cAlternatives.eContents().get(1);
		private final Keyword cMacosM1LargeGen1Keyword_2 = (Keyword)cAlternatives.eContents().get(2);
		
		//MacOsResourceClassOptions returns ecore::EString:
		//    'macos.x86.medium.gen2*' | 'macos.m1.medium.gen1' | 'macos.m1.large.gen1';
		@Override public ParserRule getRule() { return rule; }
		...
		public Keyword getMacosX86MediumGen2Keyword_0() { return cMacosX86MediumGen2Keyword_0; }
		
		//'macos.m1.medium.gen1'
		public Keyword getMacosM1MediumGen1Keyword_1() { return cMacosM1MediumGen1Keyword_1; }
		
		//'macos.m1.large.gen1'
		public Keyword getMacosM1LargeGen1Keyword_2() { return cMacosM1LargeGen1Keyword_2; }
	}
	public class DockerElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cResourceClassEStringParserRuleCall_1_6_0 = (RuleCall)cResourceClassAssignment_1_6.eContents().get(0);
		private final Group cGroup_1_7 = (Group)cGroup_1.eContents().get(7);
		...
		//EString
		public RuleCall getResourceClassEStringParserRuleCall_1_6_0() { return cResourceClassEStringParserRuleCall_1_6_0; }
	...
	private final MacOsResourceClassOptionsElements pMacOsResourceClassOptions;
	...
	public CircleciGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pMacOsResourceClassOptions = new MacOsResourceClassOptionsElements();
	...
	//MacOsResourceClassOptions returns ecore::EString:
	//    'macos.x86.medium.gen2*' | 'macos.m1.medium.gen1' | 'macos.m1.large.gen1';
	public MacOsResourceClassOptionsElements getMacOsResourceClassOptionsAccess() {
		return pMacOsResourceClassOptions;
	}
	
	public ParserRule getMacOsResourceClassOptionsRule() {
		return getMacOsResourceClassOptionsAccess().getRule();
	}
