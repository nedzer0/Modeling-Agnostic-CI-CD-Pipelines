...
public class CommandItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Command_Description_feature",
								"_UI_Command_type"),
						DevOpsPackage.Literals.COMMAND__DESCRIPTION, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DevOpsPackage.Literals.COMMAND__TOOL);
			childrenFeatures.add(DevOpsPackage.Literals.COMMAND__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((Command) object).getDescription();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DevOpsPackage.Literals.COMMAND__TOOL,
				DevOpsFactory.eINSTANCE.createTool_Framework()));

		newChildDescriptors.add(createChildParameter(DevOpsPackage.Literals.COMMAND__PARAMETERS,
				DevOpsFactory.eINSTANCE.createParameters()));
	}
