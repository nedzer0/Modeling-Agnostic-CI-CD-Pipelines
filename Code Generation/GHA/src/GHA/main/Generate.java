...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/GHA/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
         ...
         */
        if (!isInWorkspace(GHA_metamodelPackage.class)) {
        	resourceSet.getPackageRegistry().put(GHA_metamodelPackage.eNS_URI, GHA_metamodelPackage.eINSTANCE);
        }
    }
