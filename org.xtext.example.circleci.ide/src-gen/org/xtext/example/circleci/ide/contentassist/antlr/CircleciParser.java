...
public class CircleciParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CircleciGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMacOsResourceClassOptionsAccess().getAlternatives(), "rule__MacOsResourceClassOptions__Alternatives");
			...
			builder.put(grammarAccess.getJobAccess().getExecutorsAssignment_1_8(), "rule__Job__ExecutorsAssignment_1_8");
